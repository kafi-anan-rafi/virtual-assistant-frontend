      ...
      {email !== null ? (
        <>
          <div className="flex md:order-2">
            <Link href="/doctor/dashboard" className="text-white mx-6 bg-gray-400 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 mx-6 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">DashBoard</Link>
